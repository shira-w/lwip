...
/* #define USE_PCAPIF 1 */
#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), 192,168,41,11)
#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), 10,57,163,16)
...
#define LWIP_MAC_ADDR_BASE            {0x00,0x01,0x02,0x03,0x04,0x08}
